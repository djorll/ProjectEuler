...
for i in range(1,10000):
	...
	while len(pandigital) < 9:
		...
		pandigital += str(facteur * i)
		facteur += 1
		# le résultat possible est un nombre de 9 chiffres, composé de 9 chiffres différents, et 0 n'en fait pas partie
		if len(pandigital) == 9 and len(set(pandigital)) == 9 and '0' not in pandigital:
